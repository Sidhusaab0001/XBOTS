...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/Girls_Boys_Dpz_Store"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/mohabxt")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://graph.org/file/33114ba962db300bf4184.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴘᴇʜʟᴇ sɪᴅʜᴜ ᴋᴏ ᴀᴘɴɪ ʙᴇʜᴀɴ ᴋɪ ɢᴀɴᴅ ᴅɪʟᴀᴏ !! @X_SIDHU", cache_time=0, alert=True)
